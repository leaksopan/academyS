...
<div class="container py-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="mb-3">Edit Coding Exercise</h1>
            <p class="text-muted">Edit latihan coding: <strong><?= $exercise['title'] ?></strong></p>
        </div>
    ...
    <div class="card">
        <div class="card-body">
            <?= form_open('admin/edit_coding_exercise/' . $exercise['id']); ?>
                <div class="mb-3">
                    <label for="title" class="form-label">Judul Exercise</label>
                    <input type="text" class="form-control <?= form_error('title') ? 'is-invalid' : '' ?>" id="title" name="title" value="<?= set_value('title', $exercise['title']) ?>">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= form_error('lesson_id') ? 'is-invalid' : '' ?>" id="lesson_id" name="lesson_id">
                        ...
                        <?php foreach($lessons as $lesson): ?>
                            <option value="<?= $lesson['id'] ?>" <?= set_value('lesson_id', $exercise['lesson_id']) == $lesson['id'] ? 'selected' : '' ?>>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= form_error('language') ? 'is-invalid' : '' ?>" id="language" name="language">
                        ...
                        <option value="html" <?= set_value('language', $exercise['language']) == 'html' ? 'selected' : '' ?>>HTML</option>
                        <option value="css" <?= set_value('language', $exercise['language']) == 'css' ? 'selected' : '' ?>>CSS</option>
                        <option value="javascript" <?= set_value('language', $exercise['language']) == 'javascript' ? 'selected' : '' ?>>JavaScript</option>
                        <option value="php" <?= set_value('language', $exercise['language']) == 'php' ? 'selected' : '' ?>>PHP</option>
                    </select>
                    <div class="invalid-feedback">
                        <?= form_error('language') ?>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= form_error('instructions') ? 'is-invalid' : '' ?>" id="instructions" name="instructions" rows="5"><?= set_value('instructions', $exercise['instructions']) ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control code-editor <?= form_error('starter_code') ? 'is-invalid' : '' ?>" id="starter_code" name="starter_code" rows="8"><?= set_value('starter_code', $exercise['starter_code']) ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control code-editor <?= form_error('solution_code') ? 'is-invalid' : '' ?>" id="solution_code" name="solution_code" rows="8"><?= set_value('solution_code', $exercise['solution_code']) ?></textarea>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= form_error('test_cases') ? 'is-invalid' : '' ?>" id="test_cases" name="test_cases" rows="5"><?= set_value('test_cases', $exercise['test_cases']) ?></textarea>
                    <div class="invalid-feedback">
